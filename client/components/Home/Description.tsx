  ...
  return (
    <main className='flex min-h-screen items-center justify-center'>
      <motion.div
        ...
        whileInView='visible'
        animate='hidden'
        className='flex h-full w-full flex-col items-center space-y-16 p-2 py-10 md:w-3/5 lg:px-4'
      >
        {/* Description */}
        ...
        <h3 className='text-center text-xl font-light leading-10 text-[#c6c6c6] md:text-2xl'>
